function StackSvg() {
    return (
        <svg className="w-full h-full stroke-primary-foreground" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function LayoutSvg() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full stroke-secondary-foreground" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    return (
        <svg viewBox="0 0 388 155" fill="none" className="w-full h-full">
            <path
                ...
                fill="transparent"
                strokeWidth="5"
                className="stroke-primary-decoration"
                strokeMiterLimit="10"
            />
        </svg>
    );
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 422 284" fill="none" className="w-full h-full">
            <path
                ...
                fill="transparent"
                strokeWidth="5"
                className="stroke-secondary-decoration"
                strokeMiterLimit="10"
            />
        </svg>
    );
...
function ResumeAndArticleRow() {
    return (
        <div className="h-fit w-full flex gap-[30px] flex-col sm:flex-row items-center justify-center">
            <div className="relative max-w-[320px] w-full sm:w-[280px] lg:w-[300px] lg:flex-none h-[240px] overflow-hidden rounded-[10px] bg-primary">
                <div className="absolute top-0 left-0 flex-none h-full w-full pt-[40px] pb-[22px] px-[20px] z-10">
                    <div className="flex flex-col w-full h-full gap-[24px]">
                        ...
                        <div className="w-full h-full flex-1 flex flex-col justify-between">
                            <div className="text-primary-foreground text-[24px] leading-[24px] h-fit w-full font-medium pt-2">Personal Project<br/>Showcase <br/>Coming Soon</div>
                            <div className="flex justify-end h-[32px] w-full">
                                <div className="w-[32px] h-[32px] border border-primary-foreground rounded-[6px] p-[6px] text-primary-foreground hover:text-primary bg-transparent hover:bg-primary-foreground hover:cursor-pointer">
                                    <ArrowSvg />
                                </div>
                            </div>
                        </div>
            ...
            <div className="relative max-w-[320px] w-full sm:w-[280px] lg:w-full lg:flex-1 h-[240px] overflow-hidden rounded-[10px] bg-secondary">
                <div className="absolute top-0 left-0 w-full h-full flex-1 pt-[40px] pb-[22px] px-[20px] z-10">
                    <div className="flex flex-col w-full h-full gap-[24px]">
                        ...
                        <div className="w-full h-full flex-1 flex flex-col justify-between">
                            <div className="text-secondary-foreground text-[24px] leading-[24px] h-fit w-full font-medium">Technical Blogs<br/>Comming Soon</div>
                            <div className="flex justify-end h-[32px] w-full">
                                <div className="w-[32px] h-[32px] border border-secondary-foreground rounded-[6px] p-[6px] text-secondary-foreground hover:text-secondary bg-transparent hover:bg-secondary-foreground hover:cursor-pointer">
                                    <ArrowSvg />
                                </div>
                            </div>
                        </div>
